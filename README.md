...
> **نبذة بالعربية**
>  تهادوا هو نظام يساعد المستخدم على اختيار الهدية المناسبة بطريقة أذكى وأسهل. يعتمد على بيانات المستلم وتفضيلاته، ثم يستخدم الذكاء الاصطناعي لطرح أسئلة مخصصة واقتراح أفكار هدايا مناسبة. كما يدعم البحث عن منتجات حقيقية عبر SearchAPI.io، وإنشاء بطاقات هدايا مع رمز QR باستخدام ZXing، والتصويت على الهدايا الجماعية مع إشعارات عبر البريد الإلكتروني. ويشمل أيضًا التذكيرات للمناسبات القادمة من خلال Twilio، وتتبع سجل الهدايا، مع ميزات مدفوعة مرتبطة بنظام الدفع Moyasar.
---
